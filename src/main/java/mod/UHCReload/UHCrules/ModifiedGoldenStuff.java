...
import mod.UHCReload.util.Misc;
...
public class ModifiedGoldenStuff {
	...
	public static void harderGlisteringMelon(){
		if (configHandler.harderGlisteringMelon){
			...
			GameRegistry.addShapelessRecipe(new ItemStack(Items.speckled_melon), new Object[] {Items.melon, Blocks.gold_block});
		}
	}
	...
	public void onPlayerDeath(PlayerDropsEvent Event){
		Event.entityPlayer.dropItem(Misc.getSkullWithOwner(Event.entityPlayer.getName()), true, true);
	}
